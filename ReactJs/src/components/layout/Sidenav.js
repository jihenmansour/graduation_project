...
function Sidenav({ color },props) {
  ...
  return (
    <>
      <div className="brand">
        <span>Axia board</span>
      </div>
      <hr />
      <Menu theme="light" mode="inline">
        <Menu.Item key="1">
          <NavLink to={"/dashboard/"+`${idData}`+'&'+`${userData}`}>
            <span
              className="icon"
              style={{
        ...
        <Menu.Item key="2">
          <NavLink to={'/tables/'+`${idData}`+'&'+`${userData}`}>
            <span
              className="icon"
              style={{
            ...
            <span className="label">Taches</span>
          </NavLink>
        </Menu.Item>
        {role == "Admin" ? 
        <Menu.Item key="3">
        ...
        : ''}
        <Menu.Item key="4">
          <NavLink to={"/calendar/"+`${idData}`+'&'+`${userData}`}>
            <span
              className="icon"
              style={{
        ...
        <Menu.Item key="8">
          <NavLink to="/sign-up" onClick={clear}>
